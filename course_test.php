                ...
                <div class='col col-8 courseheader'>
                   ...
                   <?php
                    ...
                    <div class='row'>
                        ...
                        <span class='col center'><?php echo"<a target='_blank' href='converttopdf1.php?course=".$course."&heading=".$heading."'><button class='btn btn-light'><i class='fa fa-file-pdf-o'></i> Pdf version</button></a>"; ?></span>
