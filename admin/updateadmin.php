...
$sql1="SELECT * FROM login where usertype='admin'";
    ...
    <div class="row" style="margin:0px;margin-top:10px;padding:0px;">
        ...
        <div class="col col-10">
            ...
            <div id="Add" class="w3-container center" style="display">
                <h2 style="color:#096d96;background-color:#eee;">Update Admins</h2>
                            ...
                            <table class="table table-hover" id="heading" style="display:">
                                ...
                                if(mysqli_num_rows($res1)>0)
                                    ...
                                    while($row1=mysqli_fetch_assoc($res1)){
                                        ...
                                        <td>".$row1["email"]."</td>
                                        <td>
                                            <a class='btn btn-danger' href='deleteadmin.php?id=".$row1["id"]."&name=".$_SESSION["name"]."'>Delete</a>
                                            </td>
                                        </tr>";
                                        $i++;
                                    }
