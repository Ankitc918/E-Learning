...
if(! $id){
 ...
 if(isset($_POST["del"])){
     if($name==$username){
         ...
         window.location.href='updatemessage.php';</script>";
     }else{
  ...
  <div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body center" style="color:red">
          <b>Are you sure you want to delete this query?</b>
        </div>
          ...
          <div class="container">
               <div class="row">
                            ...
                            <div class="col col-sm-3">
                                ...
                                <div class="col col-sm">
                                    <input type="text" id="name" name="name" class="form-control" value="<?php echo $name; ?>" disabled>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col col-sm-3">
                            ...
                            <div class="col col-sm-3">
                                ...
                                <div class="col col-sm">
                                    <textarea rows="5" type="text" id="message" name="message" class="form-control" value="" disabled><?php echo $message; ?></textarea>
                                </div>
                            </div><br>
        ...
        <form method="post">
         <button type="submit" name="del" id="del" class="btn btn-danger">Confirm</button>
          <a class="btn btn-default" href="updatemessage.php">Cancel</a>
          </form>
        </div>
      </div>
    </div>
